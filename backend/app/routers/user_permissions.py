...
def assign_role_to_user(
    ...
    return Message(message=f"Role '{assignment.role_name}' assigned to user '{assignment.user_email}'")
...
def remove_role_from_user(
    ...
    return Message(message=f"Role '{assignment.role_name}' removed from user '{assignment.user_email}'")
...
def grant_scope_to_user(
    ...
    return Message(message=f"Scope '{grant.scope}' granted to user '{grant.user_email}'")
...
def revoke_scope_from_user(
    ...
    return Message(message=f"Scope '{grant.scope}' revoked from user '{grant.user_email}'")
