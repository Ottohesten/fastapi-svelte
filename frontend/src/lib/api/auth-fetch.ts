...
export async function authFetch(fetchFn: typeof fetch, url: string, options: RequestInit & { getAuthToken: () => string | undefined, setAuthToken: (t: string) => void, getRefreshToken?: () => string | undefined, setRefreshToken?: (t: string) => void }) {
