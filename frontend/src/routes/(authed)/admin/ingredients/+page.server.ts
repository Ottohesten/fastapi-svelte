...
export const load = async ({ fetch, locals }) => {
    ...
    return {
        ingredients: data,
        ingredientCreateForm: await superValidate(zod(IngredientSchema), { id: 'ingredientCreateForm' }),
        ingredientUpdateForm: await superValidate(zod(IngredientUpdateSchema), { id: 'ingredientUpdateForm' })
    }
}
