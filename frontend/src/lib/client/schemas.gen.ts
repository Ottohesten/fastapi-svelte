...
export const GamePlayerPublicSchema = {
    ...
    type: "object",
    required: ["name", "id", "game_session_id", "drink_links"],
...
export const GameSessionPublicSchema = {
    ...
    type: "object",
    required: ["title", "id", "created_at", "owner", "players", "teams"],
...
export const GameTeamPublicSchema = {
    ...
    type: "object",
    required: ["name", "id", "players", "game_session_id"],
...
export const UserWithPermissionsPublicSchema = {
    ...
    type: "object",
    required: ["email", "id", "roles", "custom_scopes", "effective_scopes"],
...
export const RecipePublicWritableSchema = {
    ...
    type: "object",
    required: ["title", "id", "owner", "ingredient_links"],
    title: "RecipePublic"
} as const;
