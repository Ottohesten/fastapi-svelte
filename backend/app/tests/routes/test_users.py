...
def test_create_user_existing_username_2(
...
def test_get_users_by_normal_user(
    client: TestClient, normal_user_token_headers: dict[str, str], db: Session
) -> None:
    """
    Test the /users/ endpoint for normal user
...
def test_update_user_me_by_superuser(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
    Test the /users/me endpoint for superuser
...
def test_update_user_me_email_exists_by_normal_user(
    client: TestClient, normal_user_token_headers: dict[str, str], db: Session
) -> None:
    """
    test the users/me endpoint for normal user
...
def test_update_user_me_email_exists_by_superuser(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
    test the users/me endpoint for superuser
...
def test_update_user_me_same_password_error(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
...
def test_update_user_by_superuser_not_exists(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
...
def test_update_user_by_superuser_email_exists(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
...
def test_delete_user_me_by_superuser(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
    Test the /users/me endpoint for superuser
    """
    r = client.delete("/users/me", headers=superuser_token_headers)
    assert r.status_code == 403
...
def test_delete_user_by_superuser_not_exists(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
...
def test_delete_user_current_user_superuser(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    """
